...
import src.com.stack.LinkedListBasedStack;
import src.com.stack.StackADT;
...
public class BinarySearchTree<T extends Comparable<T>> implements TreeADT<T> {
    ...
    @Override
    public Iterator<T> traverse(TreeIteratorType treeIteratorType) {
        switch (treeIteratorType) {
    ...
    private Iterator<T> inOrderTraverse() {
        ...
        final int exceptedCount = nodeCount;
        ...
        return new Iterator<T>() {
            ...
            public boolean hasNext() {
                if (exceptedCount != nodeCount) throw new ConcurrentModificationException();
